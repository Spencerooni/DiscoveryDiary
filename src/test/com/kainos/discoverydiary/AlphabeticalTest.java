...
public class AlphabeticalTest {
    ...
    public void getAllMediaReturnsMediaInAlphabeticalOrder() {
        ...
        //Assert
        result.getMedias().equals("Advances in Relationship Marketing");
        result.getMedias().equals("Oat So Simple");
        result.getMedias().equals("Windows Server 2003 Network Infrastructure");
    }
}
