...
public class DiscoveryDiaryApplication extends Application<DiscoveryDiaryConfiguration> {
    ...
    public static void addDummyData() {
        ...
        addMedia(new Media("Security+", "Emmett Dulaney", "CompTIA Security+Study Guide, Fifth Edition", Category.TECHNICAL, "2011", "Peter Bonar", Status.IN_DISREPAIR, "https://images-na.ssl-images-amazon.com/images/I/51b1x0wczGL._AC_UL320_SR246,320_.jpg"));
